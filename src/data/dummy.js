...
import { MdOutlineSupervisorAccount, MdWork } from 'react-icons/md';
import { HiOutlineRefresh } from 'react-icons/hi';
import { GiLouvrePyramid } from 'react-icons/gi';
import { GrLocation } from 'react-icons/gr';
import avatar from './adminavatar.jpg';
...
export const gridMissionImage = (props) => (
  <div>
    <img
...
export const gridMissionstatus = (props) => (
  <button
    type="button"
...
const gridAnnonceursProfile = (props) => (
  <div className="flex items-center gap-2">
    <img
      className="rounded-full w-10 h-10"
      src={props.AnnonceursImage}
      alt="Annonceurs"
    />
    <p>{props.Name}</p>
  </div>
...
const gridAnnonceursPays = (props) => (
  <div className="flex items-center justify-center gap-2">
    <GrLocation />
    <span>{props.Pays}</span>
  </div>
);
...
const PrestatairesGridImage = (props) => (
  <div className="image flex gap-4">
    <img
      className="rounded-full w-10 h-10"
      // eslint-disable-next-line react/destructuring-assignment
      src={props.PrestatairesImage}
      alt="Annonceurs"
    />
    <div>
      <p>{props.Nomdupréstataire}</p>
      <p>{props.PrestatairesEmail}</p>
    </div>
  </div>
);

const PrestatairesGridStatus = (props) => (
...
export const PrestatairesGrid = [
  { type: 'checkbox', width: '50' },
  { headerText: 'Nom&Prénom&Email',
    width: '150',
    template: PrestatairesGridImage,
    textAlign: 'Center' },
  { field: 'Tél',
    headerText: 'Tél',
    width: '150',
  ...
  { field: 'Status',
    ...
    format: 'yMd',
    textAlign: 'Center',
    template: PrestatairesGridStatus },
  { field: 'Budget',
    headerText: 'Budget',
    width: '100',
    format: 'yMd',
...
export const AnnonceursGrid = [
  { type: 'checkbox', width: '50' },
  { headerText: 'Nom&Prénom',
    width: '150',
    template: gridAnnonceursProfile,
    textAlign: 'Center' },
  { field: 'Name',
    headerText: '',
    width: '0',
...
export const MissionGrid = [
  ...
  { field: 'Nomdupréstataire',
    headerText: 'Prestataires Name',
    width: '150',
    textAlign: 'Center',
  },
  {
...
export const PrestatairesData = [
  {
    PrestatairesID: 1015,

    Nomdupréstataire: 'ABC',
    PrestatairesEmail: 'ABC@gmail.com',
    Tél: '98000000',
    Status: 'Cancel',
    PrestatairesImage:
      avatar2,
  ...
  },
  {
    ...
    Nomdupréstataire: 'BBB',
    PrestatairesEmail: 'bbb@gmail.com',
    Tél: '55000000',
    Status: 'Pending',
    PrestatairesImage:
      avatar4,
  ...
  },
  {
    ...
    Nomdupréstataire: 'AAA',
    PrestatairesEmail: 'aaa@gmail.com',
    Tél: '20000000',
    Status: 'Completed',
    PrestatairesImage:
      avatar,
...
export const kanbanData = [
  {
    ...
    Title: 'Task - 29001',
    Status: 'Open',
    Summary: 'Analyze the new requirements gathered from the Prestataires.',
    Type: 'Story',
    Priority: 'Low',
    Tags: 'Analyze,Prestataires',
    Estimate: 3.5,
  ...
  },
  {
    ...
    Title: 'Task - 29003',
    Status: 'Open',
    Summary: 'Arrange a web meeting with the Prestataires to get new requirements.',
    Type: 'Others',
    Priority: 'Critical',
    Tags: 'Meeting',
    Estimate: 5.5,
  ...
  },
  {
    ...
    Title: 'Task - 29005',
    Status: 'Review',
    Summary: 'Fix the issues reported by the Prestataires.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Prestataires',
    Estimate: '3.5',
  ...
  },
  {
    ...
    Title: 'Task - 29011',
    Status: 'Validate',
    Summary: 'Validate the issues reported by the Prestataires.',
    Type: 'Story',
    Priority: 'High',
    Tags: 'Validation,Fix',
    Estimate: 1,
  ...
  },
  {
    ...
    Title: 'Task - 29027',
    Status: 'Open',
    Summary: 'Arrange web meeting with the Prestataires to show editing demo.',
    Type: 'Others',
    Priority: 'High',
  ...
  },
  {
    ...
    Title: 'Task - 29029',
    Status: 'Review',
    Summary: 'Fix the editing issues reported by the Prestataires.',
    Type: 'Bug',
    Priority: 'Low',
    Tags: 'Editing,Fix',
    Estimate: '3.5',
...
export const PyramidData = [
  { x: 'aa', y: 120, text: '120 ' },
  { x: 'xx,yy,zz', y: 435, text: '435 ' },
  { x: 'bb', y: 470, text: '470 ' },
  { x: 'ii,jj,kk', y: 475, text: '475 ' },
  { x: 'cc', y: 520, text: '520 ' },
  { x: 'ee,ff,gg', y: 930, text: '930 ' },
];
